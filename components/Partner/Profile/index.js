...
export default function Profile(props) {
    ...
    const [masterDataFoodType, setMasterDataFoodType] = React.useState([])
    ...
    const getMasterDataFoodType = async () => {
        ...
        if (masterDataFoodType) {
            ...
            console.log('Master Data Food Type not found.')
        }
    }
    ...
    const getRestaurantDetails = async () => {
        ...
        if (restaurantDetail) {
            ...
            let initialRestaurantForm = {
                ...
                food_type: restaurantDetail.food_type,
    ...
    if (isMobileResolution) {
        profileComponent =
            <MobileProfileComponent
                ...
                restaurant_id={restaurant_id}
                master_Data_Food_Type={masterDataFoodType}
            />
    } else {
        profileComponent =
            <WebProfileComponent
