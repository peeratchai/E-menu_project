...
import { Form, Modal, Container, Row, Col, Button, Image } from 'react-bootstrap'
...
export default function EditApprovePromoteModal(props) {
    ...
    const editPromotion = async () => {
        ...
        if (Object.keys(newErrors).length > 0) {
            ...
            const { promotedContent, bannerText, promotedImage, promotionId, image_url } = promoteForm
...
function ConfirmEditPromoteModal(props) {
    return (
        <Modal
            {...props}
            size="sm"
                ...
                <Row>
                    <Col>
                        <div style={{ textAlign: "center", color: "#85878b" }} className={utilStyles.font_size_sm}>
                            หากคุณทำการแก้ไข จะต้องผ่านการอนุมัติใหม่อีกครั้ง
                        </div>
                    </Col>
                </Row>
                <br />
