...
const UserProfileModal = (props) => {
  ...
  const findProfileFormErrors = () => {
    ...
    const newErrors = {};
    // first_name  errors
    if (!patternLetters.test(first_name))
      newErrors.first_name = "Please enter valid first name!";
    // last_name  errors
    if (!patternLetters.test(last_name))
      newErrors.last_name = "Please enter valid last name!";
    // age errors
    console.log("age", age);
    if (age !== null && age !== "" && !patternNumber.test(age))
      ...
      <Modal.Body style={{ padding: "65px 30px 45px" }}>
        <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example">
                  ...
                  <Col sm={6} style={{ marginTop: "15px" }}>
                      ...
                      <Col>
                        <Form.Group controlId="Name">
                          ...
                          <Form.Control
                            type="text"
                            onChange={(e) =>
                              setProfileform("first_name", e.target.value)
                            }
                      ...
                      <Col>
                        <Form.Group controlId="Name">
                          ...
                          <Form.Control
                            type="text"
                            onChange={(e) =>
                              setProfileform("last_name", e.target.value)
                            }
                    ...
                    <Form.Group controlId="phone">
                      ...
                      <Form.Control
                        type="text"
                        onChange={(e) =>
                          setProfileform("phoneNumber", e.target.value)
                        }
                    ...
                    <Row style={{ marginBottom: ".5rem" }}>
                      <Col>Sync with Facebook or Line</Col>
                    </Row>
                    ...
                    <div style={{ textAlign: "right", marginTop: "40px" }}>
                      ...
                      <Button className="Buttom_Close" onClick={props.onHide}>
                        Close
                      </Button>
                    </div>
                  </Col>
          ...
          <Tab eventKey="setting" title="Setting">
            <Card
              title="Term Agreements"
              style={{ marginTop: "15px", maxHeight: "60vh", overflow: "auto" }}
            >
              {termAgreement.text}
            </Card>
          </Tab>
